...
for j=1:repetitions
    ...
    for dim_loop = 1:1:length(D_full)
        ...
        projM1_pos=projBRandomHV(D,channels_v);
        projM1_neg=projBRandomHV(D,channels_v);
        projM2_pos=projBRandomHV(D,channels_a);
        projM2_neg=projBRandomHV(D,channels_a);
        projM3_pos=projBRandomHV(D,channels_v_ECG);
        projM3_neg=projBRandomHV(D,channels_v_ECG);
        projM4_pos=projBRandomHV(D,channels_a_ECG);
        projM4_neg=projBRandomHV(D,channels_a_ECG);
        projM5_pos=projBRandomHV(D,channels_v_EEG);
        projM5_neg=projBRandomHV(D,channels_v_EEG);
        projM6_pos=projBRandomHV(D,channels_a_EEG);
        projM6_neg=projBRandomHV(D,channels_a_EEG);
        % Arousal
