...
select = 1;
if (select == 1)
    HD_functions_avsubject_cim_extremeval;     % load HD functions
else 
...
%         reduced_L_TS_COMPLETE_2(reduced_L_TS_COMPLETE_2 == 2) = 1;
        ...
        [L1_1, L2_1, L_SAMPL_DATA_01_train, SAMPL_DATA_01_train, L_SAMPL_DATA_01_test, SAMPL_DATA_01_test] = genTrainTestExtremeData (TS_COMPLETE_01, L_TS_COMPLETE_01, learningFrac, 'inorder');
        [L1_2, L2_2, L_SAMPL_DATA_02_train, SAMPL_DATA_02_train, L_SAMPL_DATA_02_test, SAMPL_DATA_02_test] = genTrainTestExtremeData (TS_COMPLETE_02, L_TS_COMPLETE_02, learningFrac, 'inorder');
