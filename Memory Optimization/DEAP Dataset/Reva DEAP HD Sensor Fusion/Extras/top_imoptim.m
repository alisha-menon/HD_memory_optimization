...
%====Features and Label===
load('DEAP_data.mat')
acc_matrix = zeros(randCounter*2,10);
acc_matrix_A = zeros(randCounter,10);
acc_matrix_V = zeros(randCounter,10);
acc_matrix_Vex = zeros(randCounter,10);
acc_matrix_Aex = zeros(randCounter,10);
    features=inputs(1:40,:);
    ...
    D_full = [10000];
    acc_hamclass_A = zeros(randCounter,1);
    acc_hamclass_V = zeros(randCounter,1);
    ...
    acc_matrix_Vex(randCounter,(D/1000)) = acc_ex2v;
    ...
    %accuracy(N,2) = acc2;
    acc2
    acc_matrix(((randCounter)*2-1),(D/1000)) = acc2;
    acc_matrix_A(randCounter,(D/1000)) = acc2;
    acc_matrix_Aex(randCounter,(D/1000)) = acc_ex2a;
