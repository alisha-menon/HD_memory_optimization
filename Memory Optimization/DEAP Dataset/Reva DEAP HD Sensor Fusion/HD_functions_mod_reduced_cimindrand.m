...
function message = HD_functions_mod_reduced_cimindrand
...
function [numPat, AM] = hdctrainproj (classes, labelTrainSet1, trainSet1, trainSet2, trainSet3, trainSet4, trainSet5, CiM1, CiM2, CiM3, CiM4, CiM5, iM1, iM2, iM3, iM4, iM5, D, N, precision, channels1, channels2, channels3, channels4, channels5)
% DESCRIPTION   : train an associative memory based on input training data
%
% INPUTS:
%   labelTrainSet : training labels
...
function [accExcTrnz, accuracy, predicLabel, actualLabel, all_error] = hdcpredictproj (labelTestSet1, testSet1, testSet2, testSet3, testSet4, testSet5 , AM, CiM1, CiM2, CiM3, CiM4, CiM5, iM1, iM2, iM3, iM4, iM5, D, N, precision, classes, channels1, channels2, channels3, channels4, channels5) 
%
% DESCRIPTION   : test accuracy based on input testing data
%
% INPUTS:
