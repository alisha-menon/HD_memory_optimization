...
function [numPat, AM] = hdctrainproj (classes, labelTrainSet1, labelTrainSet2, labelTrainSet3, labelTrainSet4, labelTrainSet5, trainSet1, trainSet2, trainSet3, trainSet4, trainSet5, CiM, iM1, iM2, iM3, iM4, iM5, D, N, precision, channels1, channels2, channels3, channels4, channels5, projM1_pos, projM1_neg, projM2_pos, projM2_neg, projM3_pos, projM3_neg, projM4_pos, projM4_neg, projM5_pos, projM5_neg) 
%
% DESCRIPTION   : train an associative memory based on input training data
%
% INPUTS:
...
function [accExcTrnz, accuracy, predicLabel, actualLabel, all_error] = hdcpredictproj (labelTestSet1, testSet1, labelTestSet2, testSet2, labelTestSet3, testSet3, labelTestSet4, testSet4 , labelTestSet5, testSet5 , AM, CiM, iM1, iM2, iM3, iM4, iM5, D, N, precision, classes, channels1, channels2, channels3, channels4, channels5, projM1_pos, projM1_neg, projM2_pos, projM2_neg, projM3_pos, projM3_neg, projM4_pos, projM4_neg, projM5_pos, projM5_neg) 
%
% DESCRIPTION   : test accuracy based on input testing data
%
% INPUTS:
