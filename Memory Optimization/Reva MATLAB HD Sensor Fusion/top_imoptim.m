...
% D_full = [2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000, 10000]; %dimension of the hypervectors
D_full = [1000];
randCounter= 10;
acc_matrix = zeros(10);
...
for i=1:1:channels_v_EEG
    projM5_pos(i,:) = projMvectors_pos(i);
end
for i=1:1:channels_v
    projM1_pos(i,:) = projM5_pos(i,:);
end
for i=1:1:channels_v_ECG
    projM3_pos(i,:) = projM5_pos(i,:);
end
...
for i=1:1:channels_v_EEG
    projM5_neg(i,:) = projMvectors_neg(i);
end
for i=1:1:channels_v
    projM1_neg(i,:) = projM5_neg(i,:);
end
for i=1:1:channels_v_ECG
    projM3_neg(i,:) = projM5_neg(i,:);
end
